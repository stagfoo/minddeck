...
swatches. Icons are the whole rounded Material set, all 2,200: the editor shows
three dozen common ones for a tap, and the search icon beside them opens the
rest.
